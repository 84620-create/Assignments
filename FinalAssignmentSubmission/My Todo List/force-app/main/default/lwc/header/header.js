...
export default class Header extends LightningElement {
  ...
  eventFields = [Event_Subject, Event_Description, Event_Date__c, Event_Start_Date, Event_End_Date, Event_Related_Object, Event_Related_ID, Event_Status];
  ...
  taskFormSubmit() {
    this.dispatchEvent(new CustomEvent('task'));
    }
  eventFormSubmit() {
